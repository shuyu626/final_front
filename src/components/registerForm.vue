...
<v-dialog max-width="600" v-model="dialog">
    <v-card>
        <v-container>
            <v-card-title v-if="!$vuetify.display.xs" class="font-weight-black text-center text-h4">{{cardTitle}}</v-card-title>
            <v-card-text>
                <v-form @submit.prevent="submit" :disabled="isSubmitting">
                    ...
                    <v-row>
                        ...
                        <!-- 需求量 -->
                        <v-col cols="4" sm="3" class="my-auto text-left ps-6">
                            <label v-if="$vuetify.display.xs" class="form-label">數量</label>
							<label v-else class="form-label">{{numberTitle}}</label>
                        </v-col>
                        <v-col cols="8" sm="9">
                            <inputText
                            type="number"
