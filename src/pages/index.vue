        ...
        <v-row no-gutters>
          ...
          <v-col cols="1" class="text-center my-auto">
            <v-btn
              ...
              type="submit"
              variant="plain"
              class="rounded-md bb-1 bg-grey-lighten-4 d-none d-md-block"
              density="comfortable"
              :ripple="false"
              height="40"
              width="60"
...
// processData 函數從 JSON 中提取城市及其對應的鄉鎮市區，存入 cities 和 cityAreaMap
const processData = (data) => {
  const cityAreaMapping = {};
  const cityList = [];
  // Object.keys(data) 取出縣市
...
// watch 來監聽 selectedCity 的變化，並在城市選擇改變時更新鄉鎮市區的選項
