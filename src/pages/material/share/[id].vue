    ...
    <v-row class="mt-5 w-100 h-66 mx-auto">
      ...
      <v-col cols="12" sm="6" md="6" lg="6">
        <v-card variant="flat" class="d-none d-sm-block">
          ...
          <v-card-text class="card-text">捐贈單位</v-card-text>
          ...
          <v-card-text class="card-text">物資介紹</v-card-text>
          <v-card-text class="card-text">{{provide.description}}</v-card-text>
          <v-card-text class="card-text">所贈數量</v-card-text>
        ...
        <v-row  class="pl-4 d-flex d-sm-none">
          ...
          <v-col cols="4" class="card-text">捐贈單位</v-col>
          ...
          <v-col cols="4" class="card-text">物資介紹</v-col>
          <v-col cols="8" class="card-text"> {{provide.description}}</v-col>
          <v-col cols="4" class="card-text">所贈數量</v-col>
        ...
        <div style="width: 100%;height: 30px;text-align: right;" class="mt-5">
          ...
          <AppButton text="我要索取" width="90" class=" bg-third d-inline-block" @click="openDialog(null)" ></AppButton>
        </div>
      </v-col>
    </v-row>
